  ...
  return (
    <>
      ...
      {props.gamePhase === "livingOne" ? (
          <div
          style={{
            backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.2) 0%,rgba(0,0,0,0.2) 100%),url(${process.env.PUBLIC_URL + "/images/FullLiving-room1.png"})`,
            height: "100%",
            width: "100%",
        ...
        >
          <div className=" d-flex img-div">
            ...
            <div
              className={
                props.isGroupThreeBreaker === true && props.livingOneLignt01 === "connected"
              ...
              <img
                src={
                  props.isGroupThreeBreaker === true && props.livingOneLignt01 === "connected"
                    ...
                    ? Right : props.livingOneLignt01 === "disconnect" ? RightOff
                    : RightOff
                }
                alt=""
                className={
              ...
              <img
                src={
                  ...
                  // : SilingFanOffIMG
                    ...
                    ? SilingFanOnIMG : props.livingOneFan === "disconnect" ? SilingFanOnIMG_DD
                  : SilingFanOnIMG_DD
                }
                className={
                  props.livingOneFan === "disconnect" ? "disconnected-brightness" : ""
                }
                style={{
                  height:
                    props.isGroupThreeBreaker === true &&
            ...
            <div
              className={
                props.isGroupThreeBreaker === true && props.livingOneLignt03 === "connected"
            ...
            >
              ...
              <img
                src={
                  ...
                  ? Left : props.livingOneLignt03 === "disconnect" ? LeftOff
                  : LeftOff
                }
                alt=""
                className={
              ...
              />
                   ...
                   <div
              className={
                props.isGroupThreeBreaker === true && props.livingOneTV === "connected"
                  ? "div-living01-TV"
                  : "div-living01-TV"
              }
            >
              ...
              <img
                src={
                  ...
                  props.livingOneTV === "connected"
                    ...
                    ? TVOnIMG : props.livingOneTV === "disconnect" ? TVOffIMG
                    : TVOffIMG

                }
                alt=""
                className={
                  props.livingOneTV === "disconnect" ? "disconnected-brightness" : ""
                }
                style={{
                  height:
                    props.isGroupThreeBreaker === true &&
        ...
        >
            <div
          style={{
            backgroundImage: `url(${process.env.PUBLIC_URL + "images/LivingRoomOneIMG.png"})`,
            height: "100%",
            width: "100%",
          }}
