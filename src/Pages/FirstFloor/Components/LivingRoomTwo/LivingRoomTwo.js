    ...
    <>
      ...
      {props.gamePhase === "livingTwo" ? (
          ...
          <div className=" d-flex img-div">
            ...
            <div
              className={
                props.isGroupThreeBreaker === true && props.livingTwoLignt01 === "connected"
           ...
           {/* fan div div ................. */}
              ...
              <img
                src={
                  ...
                  props.livingTwoFan === "connected"
                    // ? SilingFanOnIMG
                    // : SilingFanOffIMG
                    ? SilingFanOnIMG : props.livingTwoFan === "disconnect" ? SilingFanOnIMG_DD
                  : SilingFanOnIMG_DD
                }
                className={
                  props.livingTwoFan === "disconnect" ? "disconnected-brightness" : ""
                }
                style={{
                  height:
                    props.isGroupThreeBreaker === true &&
            ...
            <div
              className={
                props.isGroupThreeBreaker === true && props.livingTwoSmallLamp === "connected"
              ...
              <img
                src={
                  ...
                  props.livingTwoSmallLamp === "connected"
                    ...
                    // : SmallLampOnIMG
                    // SmallLampOff_D
                    ? SmallLampOnIMG : props.livingTwoSmallLamp === "disconnect" ? SmallLampOff_D
                  : SmallLampOff_D
                }
                alt=""
                className={
                  props.livingTwoSmallLamp === "disconnect" ? "disconnected-brightness" : ""
                }
                style={{
                  height:
                    props.isGroupThreeBreaker === true &&
        ...
        >
            <div
          style={{
            backgroundImage: `url(${process.env.PUBLIC_URL + "images/LivingRoomTwoIMG.png"})`,
            height: "100%",
            width: "100%",
          }}
