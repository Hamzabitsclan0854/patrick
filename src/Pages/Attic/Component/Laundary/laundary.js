    ...
    <>
        ...
        >
          <div className=" d-flex img-div">
            ...
            <div
              className={
                props.isLaundaryBreaker === true && props.laundaryWashing === "connected"
                  ? "div-washing"
                  : "div-washing"
              }
            >
                ...
                src={
                  ...
                  props.laundaryWashing === "connected"
                    // ? WashingMachineIMGOn
                    // : WashingMachineIMG
                    ? WashingMachineIMGOn : props.laundaryWashing === "disconnect" ? WashingMachineIMG
                    : WashingMachineIMG
                }
                alt=""
                className={
                  props.laundaryWashing === "disconnect" ? "disconnected-brightness" : ""
                }
                style={{
                  height:
                    props.isLaundaryBreaker === true &&
            ...
            >
              ...
              <img
                src={
                  ...
                  ? ironOn : props.laundaryLight02 === "disconnect" ? ironOff
                  : ironOff
                 
                }
                className={
                  props.laundaryLight02 === "disconnect" ? "disconnected-brightness" : ""
                }
                style={{
                  height:
                    props.isLaundaryBreaker === true &&
