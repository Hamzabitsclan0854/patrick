  ...
  return (
    <>
      {/* {props.gamePhase === "hall" ? ( */}
        <div
          style={{
            backgroundImage: `url(${process.env.PUBLIC_URL + "/images/full-hall-ground.png"})`,
            height: "100%",
            width: "100%",
        ...
        >
          <div className=" d-flex img-div">
            ...
            <div
              className={
                props.isFirstGroupBreaker === true && props.hallLamp === "connected"
                  ? "div-lamp-On"
                  : "div-lamp"
              }
            >
              <img
                src={
                  props.isFirstGroupBreaker === true && props.hallLamp === "connected"
                    ? LampOnIMG :  props.hallLamp === "disconnect" ? LampOffIMG_D
                    : LampOffIMG
                }
                alt=""
                style={{
      ...
      {/* ) : ( */}
        ...
        >
          <div
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + "/HallIMG.png"
              })`,
              height: "100%",
              width: "100%",
            }}
